...
public class ScanOptions
{
    ...
    /// Used as threshold for B/W scans.
    /// </summary>
    ...
    /// <summary>
    /// When set, waits for OCR results and includes them in postprocessingdata.
    /// </summary>
    public bool WaitForOcrResults { get; set; }
    ...
    /// <summary>
    /// When true, applies brightness/contrast adjustments after scanning rather than passing them to the driver.
    /// </summary>
