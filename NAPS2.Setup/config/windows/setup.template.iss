...
#define AppShortName             "APDocsStudio"
#define AppLongName              "APDocs Studio"
#define AppCompany               "Atharv Pawar"
#define AppCopyrightStartYear    "2024"
#define AppCopyrightEndYear      GetDateTimeString('yyyy','','')
#define AppCopyrightCompany      "Atharv Pawar"
#define ExeName                  "APDocsStudio.exe"
...
AppPublisherURL=https://github.com/atharvpawar
AppSupportURL=https://github.com/atharvpawar
AppUpdatesURL=https://github.com/atharvpawar
...
OutputBaseFilename=apdocsstudio-{#AppVersionName}-{#AppPlatform}
...
[Icons]
Name: "{group}\APDocs Studio"; Filename: "{app}\{#ExeName}"
Name: "{commondesktop}\APDocs Studio"; Filename: "{app}\{#ExeName}"; Tasks: desktopicon
...
Root: HKLM; Subkey: "SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\AutoplayHandlers\Handlers\WIA_{{1c3a7177-f3a7-439e-be47-e304a185f932}"; ValueType: string; ValueName: "Action"; ValueData: "Scan with APDocs Studio"
...
Root: HKLM; Subkey: "SOFTWARE\Microsoft\Windows\CurrentVersion\Explorer\AutoplayHandlers\Handlers\WIA_{{1c3a7177-f3a7-439e-be47-e304a185f932}"; ValueType: string; ValueName: "Provider"; ValueData: "APDocsStudio"

Root: HKLM; Subkey: "SOFTWARE\Microsoft\Windows\CurrentVersion\StillImage\Registered Applications"; Flags:uninsdeletevalue; ValueType: string; ValueName: "APDocsStudio"; ValueData: "{app}\{#ExeName}"
...
Root: HKLM; Subkey: "SYSTEM\CurrentControlSet\Control\StillImage\Events\STIProxyEvent\{{1c3a7177-f3a7-439e-be47-e304a185f932}"; ValueType: string; ValueName: "Desc"; ValueData: "Scan with APDocs Studio"
...
Root: HKLM; Subkey: "SYSTEM\CurrentControlSet\Control\StillImage\Events\STIProxyEvent\{{1c3a7177-f3a7-439e-be47-e304a185f932}"; ValueType: string; ValueName: "Name"; ValueData: "APDocsStudio"
